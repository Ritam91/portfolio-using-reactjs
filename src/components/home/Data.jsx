...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Ritam Sinha
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">
            I'm a enthusiastic and versatile full-stack web developer, passionate about turning innovative concepts into dynamic digital solutions.
        </p>
